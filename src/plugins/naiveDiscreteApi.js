 ...
 * 如果你想在 setup 外使用 useDialog、useMessage、useNotification、useLoadingBar，可以通过 createDiscreteApi 来构建对应的
 * API。 https://www.naiveui.com/zh-CN/dark/components/discrete
 */
